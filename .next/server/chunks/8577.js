...
const regex = __webpack_require__(34671);
...
var github_slugger = __webpack_require__(50162);
...
var mdast_util_to_string = __webpack_require__(60990);
// EXTERNAL MODULE: ./node_modules/.pnpm/unist-util-is@5.1.1/node_modules/unist-util-is/index.js
var unist_util_is = __webpack_require__(39850);
...
var extend = __webpack_require__(71902);
 ...
 */ function one(node) {
    ...
    return extend_default()(true, {}, copy);
}
...
var is_buffer = __webpack_require__(24456);
...
var unist_util_visit = __webpack_require__(85665);
...
var unist_util_visit_parents = __webpack_require__(52129);
...
/* harmony export */ });
/* harmony import */ var unist_util_visit_parents__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(52129);
/**
 * @typedef {import('unist').Node} Node
 * @typedef {import('unist').Parent} Parent
 * @typedef {import('unist-util-is').Test} Test
