...
function RootLayout({ children  }) {
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("html", {
        lang: "en",
        className: (0,utils.cn)("bg-white font-sans text-slate-900 antialiased", (target_path_app_layout_tsx_import_Inter_arguments_subsets_latin_variable_font_inter_variableName_fontSans_default()).variable),
        children: [
