...
function Callout({ children , icon , type ="default" , ...props }) {
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        className: classnames_default()("my-6 flex items-start rounded-md border border-l-4 p-4", {
...
function Card({ href , className , children , disabled , ...props }) {
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        className: classnames_default()("group relative rounded-lg border border-slate-200 bg-white p-6 shadow-md transition-shadow hover:shadow-lg", disabled && "cursor-not-allowed opacity-60", className),
        ...props,
        children: [
            /*#__PURE__*/ jsx_runtime.jsx("div", {
...
const components = {
    h1: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("h1", {
            className: classnames_default()("mt-2 scroll-m-20 text-4xl font-bold tracking-tight", className),
            ...props
        }),
    h2: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("h2", {
            className: classnames_default()("mt-10 scroll-m-20 border-b border-b-slate-200 pb-1 text-3xl font-semibold tracking-tight first:mt-0", className),
            ...props
        }),
    h3: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("h3", {
            className: classnames_default()("mt-8 scroll-m-20 text-2xl font-semibold tracking-tight", className),
            ...props
        }),
    h4: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("h4", {
            className: classnames_default()("mt-8 scroll-m-20 text-xl font-semibold tracking-tight", className),
            ...props
        }),
    h5: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("h5", {
            className: classnames_default()("mt-8 scroll-m-20 text-lg font-semibold tracking-tight", className),
            ...props
        }),
    h6: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("h6", {
            className: classnames_default()("mt-8 scroll-m-20 text-base font-semibold tracking-tight", className),
            ...props
        }),
    a: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("a", {
            className: classnames_default()("font-medium text-slate-900 underline underline-offset-4", className),
            ...props
        }),
    p: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("p", {
            className: classnames_default()("leading-7 [&:not(:first-child)]:mt-6", className),
            ...props
        }),
    ul: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("ul", {
            className: classnames_default()("my-6 ml-6 list-disc", className),
            ...props
        }),
    ol: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("ol", {
            className: classnames_default()("my-6 ml-6 list-decimal", className),
            ...props
        }),
    li: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("li", {
            className: classnames_default()("mt-2", className),
            ...props
        }),
    blockquote: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("blockquote", {
            className: classnames_default()("mt-6 border-l-2 border-slate-300 pl-6 italic text-slate-800 [&>*]:text-slate-600", className),
            ...props
        }),
    img: ({ className , alt , ...props })=>// eslint-disable-next-line @next/next/no-img-element
        /*#__PURE__*/ jsx_runtime.jsx("img", {
            className: classnames_default()("rounded-md border border-slate-200", className),
            alt: alt,
            ...props
        }),
    ...
    table: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("div", {
            ...
            children: /*#__PURE__*/ jsx_runtime.jsx("table", {
                className: classnames_default()("w-full", className),
                ...props
            })
        }),
    tr: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("tr", {
            className: classnames_default()("m-0 border-t border-slate-300 p-0 even:bg-slate-100", className),
            ...props
        }),
    th: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("th", {
            className: classnames_default()("border border-slate-200 px-4 py-2 text-left font-bold [&[align=center]]:text-center [&[align=right]]:text-right", className),
            ...props
        }),
    td: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("td", {
            className: classnames_default()("border border-slate-200 px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right", className),
            ...props
        }),
    pre: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("pre", {
            className: classnames_default()("mt-6 mb-4 overflow-x-auto rounded-lg bg-slate-900 py-4", className),
            ...props
        }),
    code: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime.jsx("code", {
            className: classnames_default()("relative rounded border bg-slate-300/25 py-[0.2rem] px-[0.3rem] font-mono text-sm text-slate-600", className),
            ...props
        }),
    Image: (image_default()),
    Callout: Callout,
