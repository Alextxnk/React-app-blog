...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17234);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 57197)), "C:\\Users\\Acer\\Desktop\\Проект по курсу React\\student-dashboard\\app\\(docs)\\docs\\[[...slug]]\\page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 88956)), "C:\\Users\\Acer\\Desktop\\Проект по курсу React\\student-dashboard\\app\\(docs)\\docs\\layout.tsx"],
    ...
    const pages = ["C:\\Users\\Acer\\Desktop\\Проект по курсу React\\student-dashboard\\app\\(docs)\\docs\\[[...slug]]\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 81132))
...
// EXTERNAL MODULE: ./.contentlayer/generated/index.mjs + 5 modules
var generated = __webpack_require__(12984);
// EXTERNAL MODULE: ./lib/toc.ts
var lib_toc = __webpack_require__(18195);
// EXTERNAL MODULE: ./components/mdx.tsx + 2 modules
var mdx = __webpack_require__(18238);
// EXTERNAL MODULE: ./components/page-header.tsx
var page_header = __webpack_require__(37674);
...
// EXTERNAL MODULE: ./config/docs.ts
var docs = __webpack_require__(85022);
// EXTERNAL MODULE: ./components/icons.tsx
var icons = __webpack_require__(96570);
;// CONCATENATED MODULE: ./components/pager.tsx




function DocsPager({ doc  }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        ...
        children: [
            pager?.prev && /*#__PURE__*/ (0,jsx_runtime.jsxs)((link_default()), {
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime.jsx(icons/* Icons.chevronLeft */.P.chevronLeft, {
                        className: "mr-2 h-4 w-4"
                    }),
                    pager.prev.title
                ]
            }),
            pager?.next && /*#__PURE__*/ (0,jsx_runtime.jsxs)((link_default()), {
                ...
                children: [
                    pager.next.title,
                    /*#__PURE__*/ jsx_runtime.jsx(icons/* Icons.chevronRight */.P.chevronRight, {
...
function getPagerForDoc(doc) {
    const flattenedLinks = [
        null,
        ...flatten(docs/* docsConfig.sidebarNav */.A.sidebarNav),
        null
    ];
...
// EXTERNAL MODULE: ./components/toc.tsx
var components_toc = __webpack_require__(43862);
// EXTERNAL MODULE: ./styles/mdx.css
var styles_mdx = __webpack_require__(60080);
// EXTERNAL MODULE: ./lib/utils.ts
var utils = __webpack_require__(65628);
;// CONCATENATED MODULE: ./app/(docs)/docs/[[...slug]]/page.tsx
...
async function getDocFromParams(params) {
    ...
    const doc = generated/* allDocs.find */.hE.find((doc)=>doc.slugAsParams === slug);
    if (!doc) {
        null;
    }
    return doc;
...
async function generateMetadata({ params  }) {
    ...
    return {
        ...
        openGraph: {
            ...
            description: doc.description,
            type: "article",
            url: (0,utils/* absoluteUrl */.G)(doc.slug),
            images: [
                {
                    url: ogUrl.toString(),
                    width: 1200,
...
async function generateStaticParams() {
    return generated/* allDocs.map */.hE.map((doc)=>({
...
async function DocPage({ params  }) {
    ...
    const toc = await (0,lib_toc/* getTableOfContents */.K)(doc.body.raw);
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("main", {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime.jsx(page_header/* DocsPageHeader */._, {
                        heading: doc.title,
                        text: doc.description
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx(mdx/* Mdx */.i, {
                        code: doc.body.code
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx("hr", {
                        className: "my-4 border-slate-200 md:my-6"
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx(DocsPager, {
                        doc: doc
                    })
                ]
            }),
            /*#__PURE__*/ jsx_runtime.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime.jsx("div", {
                    ...
                    children: /*#__PURE__*/ jsx_runtime.jsx(components_toc.DashboardTableOfContents, {
                        toc: toc
                    })
                })
            })
...
/* harmony import */ var _config_docs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(85022);
/* harmony import */ var _components_sidebar_nav__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(93290);
/* harmony import */ var _components_sidebar_nav__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_sidebar_nav__WEBPACK_IMPORTED_MODULE_2__);
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("aside", {
                className: "fixed top-14 z-30 hidden h-[calc(100vh-3.5rem)] w-full shrink-0 overflow-y-auto border-r border-r-slate-100 py-6 pr-2 md:sticky md:block lg:py-10",
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_sidebar_nav__WEBPACK_IMPORTED_MODULE_2__.DocsSidebarNav, {
                    items: _config_docs__WEBPACK_IMPORTED_MODULE_1__/* .docsConfig.sidebarNav */ .A.sidebarNav
                })
            }),
            children
        ]
...
var __webpack_exports__ = __webpack_require__.X(0, [1381,5577,5937,9337,5226,802,5770,8577,4627,6570,8464,533,2984,5575,4391,5375], () => (__webpack_exec__(58230)));
