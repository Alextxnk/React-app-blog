...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DashboardBillingLoading)
/* harmony export */ });
...
function DashboardBillingLoading() {
...
var auth = __webpack_require__(94777);
// EXTERNAL MODULE: ./lib/session.ts
var session = __webpack_require__(11207);
// EXTERNAL MODULE: ./node_modules/.pnpm/stripe@11.1.0/node_modules/stripe/lib/stripe.js
var stripe = __webpack_require__(5285);
...
var db = __webpack_require__(13155);
...
// EXTERNAL MODULE: ./components/billing-form.tsx
var billing_form = __webpack_require__(77933);
// EXTERNAL MODULE: ./components/header.tsx
var header = __webpack_require__(26484);
// EXTERNAL MODULE: ./components/shell.tsx
var shell = __webpack_require__(65215);
// EXTERNAL MODULE: ./components/ui/card.tsx
var card = __webpack_require__(57860);
;// CONCATENATED MODULE: ./app/(dashboard)/dashboard/billing/page.tsx
...
async function BillingPage() {
    ...
    if (!user) {
        (0,navigation.redirect)(auth/* authOptions */.L?.pages?.signIn || "/login");
    }
    const subscriptionPlan = await getUserSubscriptionPlan(user.id);
    // If user has a pro plan, check cancel status on Stripe.
    let isCanceled = false;
    if (subscriptionPlan.isPro && subscriptionPlan.stripeSubscriptionId) {
        const stripePlan = await stripe_stripe.subscriptions.retrieve(subscriptionPlan.stripeSubscriptionId);
        isCanceled = stripePlan.cancel_at_period_end;
    }
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(shell/* DashboardShell */.r, {
        children: [
            /*#__PURE__*/ jsx_runtime.jsx(header/* DashboardHeader */.x, {
                heading: "Billing",
                text: "Manage billing and your subscription plan."
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                className: "grid gap-10",
                children: [
                    /*#__PURE__*/ jsx_runtime.jsx(billing_form.BillingForm, {
                        subscriptionPlan: {
                            ...subscriptionPlan,
                            isCanceled
                        }
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(card/* Card */.Z, {
                        children: [
                            /*#__PURE__*/ jsx_runtime.jsx(card/* Card.Header */.Z.Header, {
                                children: /*#__PURE__*/ jsx_runtime.jsx(card/* Card.Title */.Z.Title, {
                                    children: "Note"
                                })
                            }),
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)(card/* Card.Content */.Z.Content, {
                                className: "space-y-4 pb-6 text-sm",
                                children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [1381,5937,9337,5226,4217,8948,3360,5285,4136,7226,8464,1333,7562,5207], () => (__webpack_exec__(57395)));
