...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17234);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 96669)), "C:\\Users\\Acer\\Desktop\\Проект по курсу React\\student-dashboard\\app\\(marketing)\\[...slug]\\page.tsx"],
    ...
    const pages = ["C:\\Users\\Acer\\Desktop\\Проект по курсу React\\student-dashboard\\app\\(marketing)\\[...slug]\\page.tsx"];
...
/* harmony import */ var _config_site__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(23222);
...
async function generateMetadata({ params  }) {
    ...
    ogUrl.searchParams.set("type", _config_site__WEBPACK_IMPORTED_MODULE_5__/* .siteConfig.name */ .J.name);
    ...
    return {
        ...
        openGraph: {
            ...
            description: page.description,
            type: "article",
            url: (0,_lib_utils__WEBPACK_IMPORTED_MODULE_6__/* .absoluteUrl */ .G)(page.slug),
            images: [
                {
                    url: ogUrl.toString(),
                    width: 1200,
...
var __webpack_exports__ = __webpack_require__.X(0, [1381,5577,5937,9337,5226,2584,802,5770,4136,7226,6570,8464,533,8672,2984,975,5575], () => (__webpack_exec__(96046)));
